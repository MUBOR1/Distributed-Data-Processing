...
📷 [СКРИНШОТ 1: Создание RDD из коллекции — вывод результатов](./image/result_rdd.png)
...
📷 [СКРИНШОТ 2: Трансформации с числами — фильтрация и маппинг](./image/maping_result.png)
...
📷 [СКРИНШОТ 3: Создание RDD из файла и вывод логов](./image/rdd_log.png)
...
📷 [СКРИНШОТ 4: Трансформации с логами — маппинг и фильтрация](./image/rdd_log.png)
...
📷 [СКРИНШОТ 5: Анализ логов — извлечение URL и подсчет](./image/log_result_analyz1.png)
...
📷 [СКРИНШОТ 6: Финальный результат — топ-10 URL](./image/log_result_analyz2.png)
...
📷 [СКРИНШОТ 7: Альтернативная реализация с sortByKey](./image/sortbykey_result.png)
...
📷 [СКРИНШОТ 8: Общая статистика выполнения](./image/finish_spark.png)
...
📷 [СКРИНШОТ 10: Файлы проекта лабораторной работы](./image/all_files.png)
