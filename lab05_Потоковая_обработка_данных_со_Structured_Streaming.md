...
![СКРИНШОТ 1: Запуск сервера генерации данных](./lb5image/lb5startserver.png)
...
![СКРИНШОТ 2: Результаты агрегации в консоли](./lb5image/lb5query.png)
...
+--------+-----+-----------+
```
![СКРИНШОТ 3: Результаты агрегации](./lb5image/lb5analize.png)
